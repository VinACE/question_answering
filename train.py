...
f'work embedding matrix type'
# print(type(word_embedding_matrix))
# print(dir(word_embedding_matrix))
# myset = set(word_embedding_matrix)
# print(myset)
# word_embedding_matrix = torch.from_numpy(word_embedding_matrix).float().to(device)
word_embedding_matrix = torch.from_numpy(np.float32(word_embedding_matrix)) # .float().to(device) # changed float32 to float
